...
<?php } ?>
										...
										<div class="row cart-item">
											...
											<div class="col-lg-10 col-md-10 col-sm-10">
												<div class="item_remove pull-right">
													<a href="<?php echo $product['remove']; ?>"><i class="fa fa-trash-o"></i></a>
												</div>
														...
														<div class="col-sm-6">
															<div class="qty">
																<label for="quantity[<?php echo $product['key']; ?>]" id='label_cart_update'>
																	...
																	<input name="quantity[<?php echo $product['key']; ?>]" id="<?php echo $product['key']; ?>" value="<?php echo $product['quantity']; ?>" class="input-small form-control" type="number" min=0>
  ...
  <?php } ?>
								...
								<?php if ($total_money < 20) {?>
									<div class="cart_buttons">
										<p style="color:red;font-weight:700">Livraison gratuite à partir de 20€ </p>
